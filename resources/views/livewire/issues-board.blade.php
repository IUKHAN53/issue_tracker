                        ...
                        @else
                            <div class="py-4 md:py-8">
                                <div class="flex -mx-4 block overflow-x-auto pb-2"
                                     wire:sortable-group="updateTaskLabel">
                                                            ...
                                                            <div wire:sortable-group.item="{{ $task['id'] }}"
                                                                ...
                                                                <div class="pt-2 rounded-lg">
                                                                    <div class="bg-white rounded-lg shadow mb-3 p-2">
                                                                        <div
                                                                            class="text-gray-800">{{$task['name']}}</div>
                                                                        <div
                                                                            class="text-primary-light">{{$task['project']}}
                                                                            - {{$task['boardName']}}</div>
                                                                        <div
                                                                            class="text-gray-500 text-xs">{{\Carbon\Carbon::parse($task['date'])->diffForHumans()}}</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        @endif
